...
export function GallerySlider({ beforeImage, afterImage, title }: GallerySliderProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-9 h-9 bg-white rounded-full flex items-center justify-center text-sm shadow-lg z-20" style={{ left: `${sliderPos}%` }} aria-hidden="true">↔</div>
